...
- Keep light weapons snappy and the camera free during attacks. Mouse motion continuously steers held weapons without an attack button; LMB only starts one physical stab. Small wiggles cannot accumulate swing damage. Heavy weapons wind up slowly and release fast. NPC defense reacts to visible attacks with a delay and uses the same stamina limits as players.
